    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-fuchsia-500/10 border border-fuchsia-500/20 text-fuchsia-400 text-xs font-semibold">
            <Bookmark className="w-3.5 h-3.5 fill-fuchsia-400" />
            <span>Revision Repository</span>
          </div>
          <h1 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">
            Saved <span className="bg-gradient-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent">Bookmarks & Notes</span>
          </h1>
      ...
      <div className="space-y-4">
        <div className="relative max-w-xl">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-2.5 bg-slate-900/80 border border-slate-800 focus:border-violet-500 rounded-xl text-xs sm:text-sm text-white placeholder-slate-500 focus:outline-none transition"
          />
          {searchQuery && (
            <button
            ...
            return (
              <button
                ...
                className={`px-3.5 py-1.5 rounded-xl text-xs font-semibold transition ${
                  isSelected
                    ? 'bg-gradient-to-r from-violet-600 to-purple-600 text-white shadow-md shadow-violet-500/20 border border-violet-400/40'
      ...
      {filteredBookmarks.length > 0 ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-2.5">
                      <div className="w-8 h-8 rounded-lg bg-slate-800 border border-slate-700/60 flex items-center justify-center text-violet-400">
                    ...
                    {editingNoteId === item.id ? (
                      <div className="space-y-2 pt-1">
                        <textarea
                          ...
                          rows={2}
                          className="w-full px-2.5 py-1.5 bg-slate-950 border border-slate-700 rounded-lg text-xs text-white placeholder-slate-500 focus:outline-none focus:border-violet-500 resize-none"
                          autoFocus
                        />
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          <button
                            ...
                            className="px-2.5 py-1 bg-violet-600 hover:bg-violet-500 text-white font-medium rounded-md flex items-center gap-1"
                          >
        ...
        <div className="glass-card rounded-2xl p-12 text-center space-y-4 border border-slate-800 max-w-md mx-auto">
          <div className="w-12 h-12 rounded-full bg-fuchsia-500/10 flex items-center justify-center mx-auto text-fuchsia-400">
