...
export default async function CompanyDetailPage({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-8">
      ...
      <div className="glass-card rounded-2xl p-6 sm:p-8 border border-slate-800 relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="flex items-start gap-4 sm:gap-5">
          <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-slate-800/90 border border-slate-700/80 flex items-center justify-center text-white text-2xl sm:text-3xl font-extrabold shadow-inner">
      ...
      <div className="glass-card rounded-2xl p-5 sm:p-6 border border-slate-800 space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
          {trendingShifts.map((shift) => (
            <div
              key={shift.tag}
              className="p-3.5 rounded-xl bg-slate-900/70 border border-slate-800 space-y-1"
            >
              <div className="text-xs font-semibold text-white">{shift.tag}</div>
              <div className="flex items-center justify-between">
                <span className="text-[11px] text-slate-400">Recent: {shift.recentCount} mentions</span>
