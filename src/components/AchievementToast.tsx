...
export default function AchievementToast() {
  ...
  return (
    <div className="fixed top-20 right-6 z-50 animate-bounce-in max-w-sm w-full">
      <div className="p-4 rounded-2xl bg-white/95 border border-amber-300 shadow-2xl backdrop-blur-xl relative overflow-hidden">
        {/* Shimmer line */}
        ...
        <div className="flex items-start gap-3.5">
          <div className="w-10 h-10 rounded-xl bg-amber-50 border border-amber-200 flex items-center justify-center text-amber-600 shrink-0 shadow-sm">
            <Trophy className="w-5 h-5" />
          </div>

          <div className="flex-1 min-w-0 space-y-0.5">
            <div className="flex items-center justify-between">
              <span className="text-[10px] uppercase tracking-wider font-extrabold text-amber-700 flex items-center gap-1">
